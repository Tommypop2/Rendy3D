...
use rendy3d::{
	graphics::{
		camera::Camera, colour::Colour, mesh::vertices::Vertex, object::Object, pipeline::pipeline::Pipeline, screen::Screen, shapes_2d::point::AbsoluteScreenCoordinate, shapes_3d::point::Point
	},
	loaders::obj::render,
